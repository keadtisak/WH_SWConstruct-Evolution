...
<div class="row">
  ...
  <div class="col-xs-4 col-sm-12"  ><h3 >เส้น </h3></div>
	...
	<select name ="count2" id ="dialog-confirm" class="form-control" style=width:100px>
  	...
  	<div class="col-xs-4 col-sm-6" ><h3 >อื่นๆ</h3>
       <div class="col-xs-4 col-sm-6">
       	<textarea class="form-control" name ="comment" rows="1" cols="50" style="width:300px" ></textarea>
       </div></div><br>
  	<div class="col-xs-4 col-sm-6" ><h3 >จำนวนชาม</h3>
       <div class="col-xs-4 col-sm-6">
       <select name ="count4" id ="dialog-confirm" class="form-control" style=width:100px>
  		<option value="1">1</option>
  		<option value="2">2</option>
  		<option value="3">3</option>
  		<option value="4">4</option>
